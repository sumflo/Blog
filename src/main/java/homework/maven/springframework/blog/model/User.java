...
public class User {
    ...
    /** Azért kell, hogy ha két objektumnak ugyanaz az ID-je, akkor a Hibernate ugyanannak az objektumnak vegye őket (kapcsolja őket egymáshoz).
     * ==>> elvileg szükség van rá az id megfeleő működéséhez, én sem értem még nagyon.*/
    @Override
